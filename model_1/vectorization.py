...
try:
    ...
    from .preprocessing import TOKEN_PATTERN, build_tfidf_vectorizer
except ImportError:
    from pipeline_paths import (
        TRAIN_SPLIT_PATH,
        TEST_SPLIT_PATH,
...
SUPPORTED_VECTORIZATIONS = ("one_hot", "count", "tfidf")


def build_vectorizer(vectorization_name: str):
    if vectorization_name == "one_hot":
